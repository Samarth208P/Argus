...
const COMMANDS: Cmd[] = [
  { id: "monitor", label: "Live Monitor", hint: "Real-time dashboard", group: "Navigate", icon: Gauge, href: "/", keywords: "home dashboard" },
  { id: "leaderboard", label: "Integrity Leaderboard", hint: "Provider scores", group: "Navigate", icon: Trophy, href: "/#leaderboard", keywords: "rank score rpc" },
  { id: "feed", label: "Incident Feed", hint: "Live detections", group: "Navigate", icon: Broadcast, href: "/#live-feed", keywords: "incidents events" },
  ...
  { id: "add", label: "Add RPC Provider", hint: "Register an endpoint", group: "Actions", icon: Plus, href: "/#registry", keywords: "new node infura alchemy" },
  { id: "adversary", label: "Adversary Console", hint: "Inject a fault", group: "Actions", icon: Skull, href: "/#adversary", keywords: "attack simulate censor stale mutate" },
];
